...
GoogleSpreadsheetRiver.prototype.getAll = function(){

    //First check expiration...
    return this.getLastSynchronized().then(function(time){
       if(!time) {
           //synchronize the mofo
           return this.synchronize().then(this.getKeys());
       } else {
           return this.getKeys();
       }
